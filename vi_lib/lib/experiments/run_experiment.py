...
# Run the Experiment
if args.cv == 0: # it's not going a cross-validation experiment
    ...
    elif args.method == "BBB_LBFGS":
        experiments.bbb_lbfgs_base.get_variant(args.name).get_variant(args.variant).run()
    elif args.method == "UCI_SLANG":
        experiments.uci_slang_base.get_variant(args.name).get_variant(args.variant).run()
    ...
    elif args.method == "UCI_SLANG_RANDOM":
        experiments.uci_slang_random.get_variant(args.name).get_variant(args.variant).run()
    elif args.method == "UCI_BBB_RANDOM":
        experiments.uci_bbb_random.get_variant(args.name).get_variant(args.variant).run()
    else:
    ...
    if args.method == "SLANG":
        ...
        experiments.bbb_lbfgs_cv.get_variant(args.name).get_variant(args.variant).run()
    elif args.method == "UCI_SLANG":
        experiments.uci_slang_cv.get_variant(args.name).get_variant(args.variant).run()
    elif args.method == "BBB_LBFGS":
        experiments.bbb_lbfgs_cv.get_variant(args.name).get_variant(args.variant).run()
    else:
